...
* Fixed issue when no target runtime was defined, the auto-discovery used a runtime version previous to the minimum Mule version required.
...
* MTF not follows a runtime order when executing tests.
